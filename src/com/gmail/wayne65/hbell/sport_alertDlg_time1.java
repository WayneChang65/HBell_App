 ...
 * @version 1.0.0
 */
public class sport_alertDlg_time1 extends Activity {
...
//		mLogTag = alert_dlg.class.getSimpleName();
		...
		new AlertDialog.Builder(arg0).setTitle(strTitle).setMessage(strMessage)
				.setPositiveButton(strPosBtn, new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialoginterface, int i) {
						...
						if (pref.LoadSportBellCheckedValue(sport_alertDlg_time1.this) == true){
							publicFun.ringBell(sport_alertDlg_time1.this, false); 	// 停止音樂
						}
						if (mVibrator != null) mVibrator.cancel();			// 停止振動
						
						sport_alertDlg_time1.this.finish();
					}
	...
	private void _alertProcess(){
		if (pref.LoadSportBellCheckedValue(sport_alertDlg_time1.this) == true){
			publicFun.ringBell(sport_alertDlg_time1.this, true); // 撥放音樂
		}
		if (pref.LoadSportVibrationCheckedValue(sport_alertDlg_time1.this) == true){
			_vibration();
		}
		_showAlertDialog(sport_alertDlg_time1.this, "運動提醒", 
				"記得要進行" + pref.LoadSportTime1DescriptionValue(sport_alertDlg_time1.this) + "運動喔！",
				"確認", "略過");
	}
	...
	private void _vibration(){
		...
		publicFun.showToast(sport_alertDlg_time1.this, "振動中");
	}
	// Inner classes
