 ...
 * @version 1.0.0
 */
public class medic_alertDlg_time3 extends Activity {
...
//		mLogTag = alert_dlg.class.getSimpleName();
		...
		new AlertDialog.Builder(arg0).setTitle(strTitle).setMessage(strMessage)
				.setPositiveButton(strPosBtn, new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialoginterface, int i) {
						...
						if (pref.LoadMedicBellCheckedValue(medic_alertDlg_time3.this) == true){
							publicFun.ringBell(medic_alertDlg_time3.this, false); 	// 停止音樂
						}
						if (mVibrator != null) mVibrator.cancel();			// 停止振動
						
						medic_alertDlg_time3.this.finish();
					}
	...
	private void _alertProcess(){
		if (pref.LoadMedicBellCheckedValue(medic_alertDlg_time3.this) == true){
			publicFun.ringBell(medic_alertDlg_time3.this, true); // 撥放音樂
		}
		if (pref.LoadMedicVibrationCheckedValue(medic_alertDlg_time3.this) == true){
			_vibration();
		}
		_showAlertDialog(medic_alertDlg_time3.this, "吃藥提醒", 
				"請記得吃" + pref.LoadMedicTime3DescriptionValue(medic_alertDlg_time3.this) + "！",
				"確認", "略過");
	}
	...
	private void _vibration(){
		...
		publicFun.showToast(medic_alertDlg_time3.this, "振動中");
	}
	// Inner classes
