...
public class sleep extends Activity {
	...
	private void _findViews() {
		mLogTag = sleep.class.getSimpleName();
		mTime = (LinearLayout) findViewById(R.id.ll_sleep_time);
		mTimeDisplay = (TextView) findViewById(R.id.txv_sleep_time_display);
		mBellSwitch = (CheckBox) findViewById(R.id.cbx_sleep_alerttype_bell);
		mVibrationSwitch = (CheckBox) findViewById(R.id.cbx_sleep_alerttype_vibration);
		mTextSwitch = (CheckBox) findViewById(R.id.cbx_sleep_alerttype_text);
	}	
	...
	private void _loadPref_Time() {
		mHour = pref.LoadSleepTimeHourValue(this);
		mMinute = pref.LoadSleepTimeMinuteValue(this);
		
		mBellSwitch.setChecked(pref.LoadSleepBellCheckedValue(this));
		mVibrationSwitch.setChecked(pref.LoadSleepVibrationCheckedValue(this));
	}
	
	private void _savePref_Time(int iHour, int iMinute) {
		pref.SaveSleepTimeHourValue(this, iHour);
		pref.SaveSleepTimeMinuteValue(this, iMinute);
	}
	...
	private class CListener_mTime implements View.OnClickListener{
		public void onClick(View v) {
			...
			new TimePickerDialog(sleep.this, listener_timePicker, mHour, mMinute, false).show();
		}
	}	
	...
	private class CListener_timePicker implements TimePickerDialog.OnTimeSetListener{
		public void onTimeSet(TimePicker view, int hourOfDay, int minute){
			...
			Intent receiverIntent = new Intent(sleep.this, sleep_alarmReceiver.class);
			PendingIntent sender = PendingIntent.getBroadcast(sleep.this, 1, receiverIntent, 0);
			AlarmManager am;
	...
	private class CListener_mBellSwitch implements View.OnClickListener{
		public void onClick(View v) {
			...
			pref.SaveSleepBellCheckedValue(sleep.this, mBellSwitch.isChecked());
		}
	}	
	...
	private class CListener_mVibrationSwitch implements View.OnClickListener{
		public void onClick(View v) {
			...
			pref.SaveSleepVibrationCheckedValue(sleep.this, mVibrationSwitch.isChecked());
		}
	}	
    ...
    public boolean onCreateOptionsMenu(Menu menu){
    	...
    	inflater.inflate(R.menu.sleep_menu, menu);
    	return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item){
    	...
    	case R.id.mit_sleep_info:
			Intent intent = new Intent();
			intent.setClass(sleep.this, sleep_info.class);
