...
//		mLogTag = alert_dlg.class.getSimpleName();
				...
				.setPositiveButton(strPosBtn, new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialoginterface, int i) {
						...
						if (pref.LoadMedicBellCheckedValue(medic_alertDlg_time1.this) == true){
							publicFun.ringBell(medic_alertDlg_time1.this, false); 	// 停止音樂
						}
	...
	private void _alertProcess(){
		if (pref.LoadMedicBellCheckedValue(medic_alertDlg_time1.this) == true){
			publicFun.ringBell(medic_alertDlg_time1.this, true); // 撥放音樂
		}
		if (pref.LoadMedicVibrationCheckedValue(medic_alertDlg_time1.this) == true){
			_vibration();
		}
		_showAlertDialog(medic_alertDlg_time1.this, "吃藥提醒", 
				"請記得吃" + pref.LoadMedicTime1DescriptionValue(medic_alertDlg_time1.this) + "！",
				"確認", "略過");
	}
	...
	private void _vibration(){
		...
		publicFun.showToast(medic_alertDlg_time1.this, "振動中");
	}
	// Inner classes
